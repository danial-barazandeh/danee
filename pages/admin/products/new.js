    ...
    return (<div className='lg:px-8 py-8'>
        <form>
            <div className='bg-background rounded-lg shadow-lg p-8 flex flex-col gap-4'>
                ...
                <div className='flex gap-4 justify-start items-center'>
                    <label for="seoTitle" className='w-[15%] font-bold'>ویدئو پیش نمایش</label>
                ...
                <div className='flex gap-4 justify-start items-center'>
                    <label for="seoTitle" className='w-[15%] font-bold'>قیمت</label>
                ...
                <div className='flex gap-4 justify-start items-center'>
                    <label for="seoTitle" className='w-[15%] font-bold'>قیمت پس از تخفیف</label>
                ...
                <div className='flex gap-4 justify-start items-center'>
                    <label for="seoTitle" className='w-[15%] font-bold'>ساعت دوره</label>
                ...
                <div className='flex gap-4'>
                    {chips.map((chip, index) => {
                        return (<Chip id={index} label={chip} onDelete={() => handleChipDelete(chip)} />);
                    })}
                </div>
